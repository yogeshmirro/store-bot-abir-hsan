...
from handlers.MultiChannel import get_db_channel
...
async def send_media_and_reply(bot: Client, user_id: int, file_id: int, chat_id: int):
    sent_message = await media_forward(bot, user_id, file_id, chat_id)
